...
namespace Traci
{
    ...
    /// </summary>
    static class TraciConstants
    {
        // ****************************************
        // VERSION
        // ****************************************
        public const int TRACI_VERSION = 20;
        ...
        public const double INVALID_DOUBLE_VALUE = -1001.0; // -1073741824;
        // return value for invalid queries (especially vehicle is not on the road)
        public const short INVALID_INT_VALUE = -1; // double -1073741824;
        // maximum value for client ordering (2 ^ 30 - 1)
        public const uint MAX_ORDER = 1073741823; // 1073741824 (2 ^30)
        ...
        public const byte  DEPARTFLAG_LANE_FIRST_ALLOWED = 0xFA; // #* -0x06
